...
def error_404(error):
    ...
    status_msg = "Status: Not Found"
    status_code = 404
    code_msg = "Status Code: "
...
def error_500(error):
    ...
    status_msg = "Status: Internal Server Error"
    status_code = 500
    code_msg = "Status Code: "
    return render_template(
        'http_error/error.html',
...
def error_405(error):
    ...
    status_msg = "Status: Method Not Allowed"
    status_code = 405
    code_msg = "Status Code: "
    return render_template(
        'http_error/error.html',
